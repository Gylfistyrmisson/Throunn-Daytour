...
INSERT INTO daytour (name,id,price,duration,dateDay,dateMonth,dateYear,location,customerCNT,customerID,reviewCNT, reviewID, description) VALUES ('skemmtiferð',2,100,10,1,1,2001,'reykjavik',2,'0,1,',0,'','alveg æðiselgt');
INSERT INTO daytour (name,id,price,duration,dateDay,dateMonth,dateYear,location,customerCNT,customerID,reviewCNT, reviewID, description) VALUES ('fjöruferð',3,1000,100,2,2,2002,'keflavik',1,'0,',0,'','mökknæs');